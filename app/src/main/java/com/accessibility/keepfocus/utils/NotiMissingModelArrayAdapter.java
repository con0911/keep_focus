...
public class NotiMissingModelArrayAdapter extends ArrayAdapter<NotificationItemMissHistory>  {
	private final String TAG = "NotiMissingModelArrayAdapter";
	private ArrayList<NotificationItemMissHistory> mListNotiMissing = null;
...
//	}
	...
	public NotiMissingModelArrayAdapter(Activity activity,int resourId, ArrayList<NotificationItemMissHistory> list,OnTouchListener _listener){
...
//		this.mListNotiMissing.addAll(list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		NotificationItemMissHistory aNotiItem = mListNotiMissing.get(position);
	...
	static class ViewHolder{
		...
		protected NotificationItemMissHistory NotiModel;
//		protected int color;
