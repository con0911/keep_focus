...
import com.accessibility.keepfocus.utils.BackgroundContainer;
import com.accessibility.keepfocus.utils.NotiMissingModelArrayAdapter;

public class DialogNotiHistory extends Dialog {
	...
	private ListView lv;
	private BlockNotificationActivity mActivity;
	private NotiMissingModelArrayAdapter notiAdapter;
	private BackgroundContainer mBackgroundContainer;
	private ArrayList<NotificationItemMissHistory> mListMissingNotification;
	...
	public DialogNotiHistory(Context mContext,
			BlockNotificationActivity activity) {
	...
	private void animateRemoval(final ListView listview, View viewToRemove) {
		...
		NotificationItemMissHistory a_NotiItemMissRemoved = mListMissingNotification
				.get(position);
	...
	private void readNotiItemSelected(final ListView lv, View viewSelected) {
		...
		for (int i = 0; i < lv.getChildCount(); i++) {
			...
			if (child == viewSelected) {
				...
				NotificationItemMissHistory aNotiItemSeleted = mListMissingNotification
						.get(position);
